          ...
          <div className="order-2 md:order-1">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold mb-4 font-playfair">
                <span className="text-purple-600">Нейро</span>фотосессии нового поколения
              </h1>
              <p className="text-lg md:text-xl text-gray-700 mb-8 max-w-xl">
                Раскройте свою индивидуальность с помощью фотосессий, созданных с учетом особенностей вашего восприятия и эмоций
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button variant="outline" className="border-purple-600 text-purple-600 hover:bg-purple-50 py-6 px-8 text-lg">
                  Смотреть портфолио
                </Button>
              </div>
              ...
              <div className="mt-8 flex items-center space-x-4">
                ...
                <div className="text-sm text-gray-600">
                  <span className="font-bold text-purple-600">+50</span> довольных клиентов в этом месяце
                </div>
              </div>
            </motion.div>
          </div>
